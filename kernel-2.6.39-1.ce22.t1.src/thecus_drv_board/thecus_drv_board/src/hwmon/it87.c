...
extern int f75387sg_rw(u8 addr, u8 reg_num, u8 * val, int wr);
#define f75387sg1_rw(reg, val, wr) f75387sg_rw(0x2d, (reg), (val), (wr))
#define f75387sg2_rw(reg, val, wr) f75387sg_rw(0x2e, (reg), (val), (wr))
...
static int thecus_it87_init_procfs(void)
{
    ...
    if (!pde)
      return -ENOMEM;
    pde->proc_fops = &thecus_proc_it87_operations;
