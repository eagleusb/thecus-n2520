...
class TinyAjax
{
	...
	public function addStdBehaviors()
	{
		...
		$this->addBehavior( new TabGetOptions());
		$this->addBehavior( new TabRemoveSelectedOption());
		$this->addBehavior( new TabRedirect());
		$this->addBehavior( new ChgDisabled());
		$this->addBehavior( new ChgMultiDisabled());
		$this->addBehavior( new TabEval());
		$this->addBehavior( new TabRemoveFirstOption());
		$this->addBehavior( new ChgMultiHidden());
		$this->addBehavior( new ChgHidden());
		$this->addBehavior( new ChgSrc());
		$this->addBehavior( new SetMutiTagItem());
		$this->addBehavior( new SetStyle());
	}
