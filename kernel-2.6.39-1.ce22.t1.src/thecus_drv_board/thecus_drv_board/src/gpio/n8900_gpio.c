...
static int __devinit pch_6_gpio_probe(struct pci_dev *, const struct pci_device_id *);
...
static int __devinit pch_6_gpio_probe(struct pci_dev *pdev, const struct pci_device_id *ent)
{
    int ret;
