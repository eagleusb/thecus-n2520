...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Debug.mk dist/Debug/GNU-Linux-x86/agent3

dist/Debug/GNU-Linux-x86/agent3: ${OBJECTFILES}
...
${OBJECTDIR}/cmd.o: nbproject/Makefile-${CND_CONF}.mk cmd.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/cmd.o cmd.c

${OBJECTDIR}/cmd_queue.o: nbproject/Makefile-${CND_CONF}.mk cmd_queue.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/cmd_queue.o cmd_queue.c
...
${OBJECTDIR}/scr_template.o: nbproject/Makefile-${CND_CONF}.mk scr_template.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/scr_template.o scr_template.c

${OBJECTDIR}/sqliteapi.o: nbproject/Makefile-${CND_CONF}.mk sqliteapi.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/sqliteapi.o sqliteapi.c
...
${OBJECTDIR}/stringtable.o: nbproject/Makefile-${CND_CONF}.mk stringtable.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/stringtable.o stringtable.c
...
${OBJECTDIR}/sysinfo.o: nbproject/Makefile-${CND_CONF}.mk sysinfo.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/sysinfo.o sysinfo.c
...
.clean-conf:
	${RM} -r build/Debug
	${RM} dist/Debug/GNU-Linux-x86/agent3
