	...
	void *p)
{
	...
	bd = blkdev_get_by_path__2(ib_dev->ibd_udev_path,
...
static void iblock_emulate_sync_cache(struct se_task *task)
{
	 ...
	 */
	ret = blkdev_issue_flush__2(ib_dev->ibd_bd, GFP_KERNEL, &error_sector);
	if (ret != 0) {
