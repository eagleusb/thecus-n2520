...
<fieldset class="x-fieldset" style="margin: 10px;"><legend class="legend"><{$words.conf_title}></legend>
<center>
<div class="step_desp"><{$words.conf_description}></div>
<div id="mainDiv1">
</div>
</center>
</fieldset>
...
Ext.onReady(function(){
    ...
    var fp2 = new Ext.FormPanel({
        ...
        buttons: [{
            ...
            handler: function(){
                if(fp2.getForm().isValid()){
	                fp2.getForm().submit({
	                    url: 'setmain.php?fun=setmgmt_usergroup&action_do=Upload',
	                    waitMsg: '<{$words.upload_file_msg}>',
        ...
        },
        {
			...
			handler: function(){
			    window.open('../adm/getmain.php?fun=setmgmt_usergroup&action_do=Download');
			}
		}        
        ]
    })
